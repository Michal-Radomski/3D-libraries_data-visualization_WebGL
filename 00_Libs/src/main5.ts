//* https://phaser.io/examples/v3.85.0/animation/view/create-animation-from-canvas-texture
...
class Example extends Phaser.Scene {
  ...
  preload(): void {
    ...
    const canvasFrame = this.textures.createCanvas("dynamicFrames", 256, 128) as Phaser.Textures.CanvasTexture;

    let radius: number = 0;
    const radiusInc: number = 16 / frameTotal;
