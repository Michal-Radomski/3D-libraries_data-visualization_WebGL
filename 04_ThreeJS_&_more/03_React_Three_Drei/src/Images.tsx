...
const Images = (): React.JSX.Element => {
  ...
  return (
    <React.Fragment>
      <group ref={groupRef}>
        <Image url="./images/1.jpg" scale={[4, height]} position={[-2, 0, 0]} grayscale={0} zoom={1} />
        <Image position={[-2.3, -height, 2]} scale={[1, 3]} url="./images/2.jpg" />
        <Image position={[-0.6, -height, 3]} scale={[1, 2]} url="./images/3.jpg" />
        <Image position={[0.75, -height, 3.5]} scale={1.5} url="./images/4.jpg" />
        <Image position={[0, -height * 1.5, 2.5]} scale={[1.5, 3]} url="./images/5.jpg" grayscale={1} />
        <Image position={[0, -height * 2 - height / 4, 0]} scale={[width, height / 2]} url="./images/6.jpg" />
      </group>
    </React.Fragment>
  );
};
